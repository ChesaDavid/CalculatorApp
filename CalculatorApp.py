...
def ScientificMode():
    ...
    btn_ln=tk.Button(window, text="ln", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    btn_ln.grid(row=5,column=4)
    
    btn_log=tk.Button(window, text="log()", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    btn_log.grid(row=6,column=4)

    btn_2topowerof=tk.Button(window, text="2()", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    btn_2topowerof.grid(row=7,column=4)

    btn_squerRoot=tk.Button(window, text="sqrt", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    ...
    btn_pi=tk.Button(window, text="-", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    btn_pi.grid(row=3,column=4)
    ...
    btn_scientificMode=tk.Button(window, text="Stand", command=lambda:standardMode(),width=5,font=("Times New Roman",8))
    btn_scientificMode.grid(row=7,column=2)
...
btn_squerRoot=tk.Button(window, text="sqrt", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
btn_factorial=tk.Button(window, text="!", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
btn_pi=tk.Button(window, text="pi", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
btn_1=tk.Button(window, text="1", command=lambda:add_to_field(1),width=5,font=("Times New Roman",13))
btn_2=tk.Button(window, text="2", command=lambda:add_to_field(2),width=5,font=("Times New Roman",13))
btn_3=tk.Button(window, text="3", command=lambda:add_to_field(3),width=5,font=("Times New Roman",13))
btn_4=tk.Button(window, text="4", command=lambda:add_to_field(4),width=5,font=("Times New Roman",13))
...
if window.title == "Standard":
    app = window.grid(row=2, col=13 , columnspan =15)
    app = ""
