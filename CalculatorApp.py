...
def standardMode():
#We are making the calculator window
...
#We are making the buttons of the window
...
btn_scientificMode=tk.Button(window, text="SM", command=lambda:ScientificMode(),width=5,font=("Times New Roman",13))
