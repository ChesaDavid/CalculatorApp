...
def ScientificMode():
    ...
    window1.configure(width="300" , height="300")
    window1.configure(bg="White")
    field1 = tk.Text(window,height="2",width="21",font=("Times New Roman",20))
    field1.grid(row="1" ,column="1", columnspan="6")
    
    btn_ln=tk.Button(window1, text="ln", command=lambda:add_to_field("ln"),width=5,font=("Times New Roman",13))
    btn_ln.grid(row=5,column=4)
    
    btn_log=tk.Button(window1, text="log()", command=lambda:add_to_field("log"),width=5,font=("Times New Roman",13))
    btn_log.grid(row=6,column=4)

    btn_2topowerof=tk.Button(window1, text="2()", command=lambda:add_to_field("2("),width=5,font=("Times New Roman",13))
    btn_2topowerof.grid(row=7,column=4)

    btn_squerRoot=tk.Button(window1, text="sqrt", command=lambda:add_to_field("sqrt("),width=5,font=("Times New Roman",13))
    btn_squerRoot.grid(row=7,column=3)

    btn_factorial=tk.Button(window1, text="!", command=lambda:add_to_field("!"),width=5,font=("Times New Roman",13))
    btn_factorial.grid(row=7,column=1)

    btn_pi=tk.Button(window1, text="pi", command=lambda:add_to_field("3.14159265359"),width=5,font=("Times New Roman",13))
    btn_pi.grid(row=7,column=2)

    btn_1=tk.Button(window1, text="1", command=lambda:add_to_field(1),width=5,font=("Times New Roman",13))
    btn_1.grid(row=4,column=1)

    btn_2=tk.Button(window1, text="2", command=lambda:add_to_field(2),width=5,font=("Times New Roman",13))
    btn_2.grid(row=4,column=2)

    btn_3=tk.Button(window1, text="3", command=lambda:add_to_field(3),width=5,font=("Times New Roman",13))
    btn_3.grid(row=4,column=3)

    btn_4=tk.Button(window1, text="4", command=lambda:add_to_field(4),width=5,font=("Times New Roman",13))
    btn_4.grid(row=3,column=1)

    btn_5=tk.Button(window1, text="5", command=lambda:add_to_field(5),width=5,font=("Times New Roman",13))
    btn_5.grid(row=3,column=2)

    btn_6=tk.Button(window1, text="6", command=lambda:add_to_field(6),width=5,font=("Times New Roman",13))
    btn_6.grid(row=3,column=3)

    btn_7=tk.Button(window1, text="7", command=lambda:add_to_field(7),width=5,font=("Times New Roman",13))
    btn_7.grid(row=2,column=1)

    btn_8=tk.Button(window1, text="8", command=lambda:add_to_field(8),width=5,font=("Times New Roman",13))
    btn_8.grid(row=2,column=2)

    btn_9=tk.Button(window1, text="9", command=lambda:add_to_field(9),width=5,font=("Times New Roman",13))
    btn_9.grid(row=2,column=3)

    btn_plus=tk.Button(window1, text="+", command=lambda:add_to_field("+"),width=5,font=("Times New Roman",13))
    btn_plus.grid(row=2,column=4)

    btn_minus=tk.Button(window1, text="-", command=lambda:add_to_field("-"),width=5,font=("Times New Roman",13))
    btn_minus.grid(row=3,column=4)

    btn_multiply=tk.Button(window1, text="x", command=lambda:add_to_field("*"),width=5,font=("Times New Roman",13))
    btn_multiply.grid(row=4,column=4)

    btn_divison=tk.Button(window1, text="/", command=lambda:add_to_field("/"),width=5,font=("Times New Roman",13))
    btn_divison.grid(row=5,column=4)

    btn_point=tk.Button(window1, text=".", command=lambda:add_to_field("."),width=5,font=("Times New Roman",13))
    btn_point.grid(row=5,column=2)

    btn_openparantese1=tk.Button(window1, text="(", command=lambda:add_to_field("("),width=5,font=("Times New Roman",13))
    btn_openparantese1.grid(row=5,column=3)

    btn_openparantese2=tk.Button(window1, text=")", command=lambda:add_to_field(")"),width=5,font=("Times New Roman",13))
    btn_openparantese2.grid(row=5,column=4)

    btn_equal=tk.Button(window1, text="=", command=lambda:calculateScientific(),width=5,font=("Times New Roman",13))
    btn_equal.grid(row=6,column=1)

    btn_clear=tk.Button(window1, text="clear", command=lambda:clear(),width=5,font=("Times New Roman",13))
    btn_clear.grid(row=6,column=3)

    btn_scientificMode=tk.Button(window1, text="Stand", command=lambda:standardMode(),width=5,font=("Times New Roman",13))
